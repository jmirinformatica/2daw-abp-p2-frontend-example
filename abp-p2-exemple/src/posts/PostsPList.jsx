...
export const PostsPList = () => {
  ...
  }, [refresh,page]); // condició d'execució del useffect

  const fetchData = async ()=> {

    try {

      const json = await fetch(apiUrl+"/posts?paginate=1&page="+page, {
        // mode: 'cors',
        headers: {
            ...
            <div className="overflow-hidden">
              ...
              {pages.map((v,i)=> {
                      ...
                      return (
                        <>
                        <button
                            onClick={() => setPage(v.label)}
                                className="text-blue-600 text-xl font-semibold hover:underline focus:outline-none px-4 py-2"
                        >{v.label}</button>
